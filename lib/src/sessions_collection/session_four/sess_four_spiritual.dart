...
class SessionFourSpiritual extends StatefulWidget {
  static const String routeName = 'session4_spiritual_screen';

  @override
  State<SessionFourSpiritual> createState() => _SessionFourSpiritualState();
}

class _SessionFourSpiritualState extends State<SessionFourSpiritual> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        //           'assets/session4/Most_beautiful_scene.mp4'),
        //       looping: true,
        //       autoplay: true,
        //     ),
        //     TextButton(
