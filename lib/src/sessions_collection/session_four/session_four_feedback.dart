...
class SessionFourFeedbackScreen extends StatefulWidget {
  final String feedBackId;
  static const String routeName = 'session_four_feedback_screen';

  const SessionFourFeedbackScreen({Key key, this.feedBackId}) : super(key: key);

  @override
  _SessionFourFeedbackScreenState createState() =>
      _SessionFourFeedbackScreenState();
}
...
class _SessionFourFeedbackScreenState extends State<SessionFourFeedbackScreen> {
  ...
  String feedBackId = "Session 4 feedback";
  ...
  void handleSubmitFeedback() {
    ...
    if (complete == true) {
      ...
      Navigator.pushReplacementNamed(context, SessionFiveScreen.routeName);
    }
  }
