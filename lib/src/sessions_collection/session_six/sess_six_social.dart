...
class SessionSixSocial extends StatefulWidget {
  static const String routeName = 'session6_social_screen';

  @override
  State<SessionSixSocial> createState() => _SessionSixSocialState();
}

class _SessionSixSocialState extends State<SessionSixSocial> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        //           'assets/session6/Qualities_good.mp4'),
        //       looping: true,
        //       autoplay: true,
        //     ),
        //     VideoItems(
        //       videoPlayerController: VideoPlayerController.asset(
        //           'assets/session6/communication_skills.mp4'),
        //       looping: true,
        //       autoplay: true,
        //     ),
        //     TextButton(
