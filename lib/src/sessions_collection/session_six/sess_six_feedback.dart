...
class SessionSixFeedbackScreen extends StatefulWidget {
  final String feedBackId;
  static const String routeName = 'session_six_feedback_screen';

  const SessionSixFeedbackScreen({Key key, this.feedBackId}) : super(key: key);

  @override
  _SessionSixFeedbackScreenState createState() =>
      _SessionSixFeedbackScreenState();
}

class _SessionSixFeedbackScreenState extends State<SessionSixFeedbackScreen> {
  ...
  String feedBackId = "Session 6 feedback";
  ...
  void handleSubmitFeedback() {
    ...
    if (complete == true) {
      ...
      Navigator.pushReplacementNamed(context, SessionSevenScreen.routeName);
    }
  }
