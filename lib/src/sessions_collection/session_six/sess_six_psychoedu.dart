...
class SessionSixPsychoedu extends StatefulWidget {
  static const String routeName = 'session6_psychoedu_screen';

  @override
  State<SessionSixPsychoedu> createState() => _SessionSixPsychoeduState();
}

class _SessionSixPsychoeduState extends State<SessionSixPsychoedu> {
