...
class SessionSixSpiritual extends StatefulWidget {
  static const String routeName = 'session6_spiritual_screen';

  @override
  State<SessionSixSpiritual> createState() => _SessionSixSpiritualState();
}

class _SessionSixSpiritualState extends State<SessionSixSpiritual> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text('SPIRITUAL SESSION SIX'),
          actions: [
            TextButton(
              onPressed: () =>
                  //sign out
        ...
        //           'assets/session6/spiritual_music.mp4'),
        //       looping: true,
        //       autoplay: true,
        //     ),
        //     TextButton(
