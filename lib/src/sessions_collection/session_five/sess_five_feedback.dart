...
class SessionFiveFeedbackScreen extends StatefulWidget {
  final String feedBackId;
  static const String routeName = 'session_five_feedback_screen';

  const SessionFiveFeedbackScreen({Key key, this.feedBackId}) : super(key: key);

  @override
  _SessionFiveFeedbackScreenState createState() =>
      _SessionFiveFeedbackScreenState();
}

class _SessionFiveFeedbackScreenState extends State<SessionFiveFeedbackScreen> {
  ...
  String feedBackId = "Session 5 feedback";
