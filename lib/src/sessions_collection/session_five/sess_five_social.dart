...
class SessionFiveSocial extends StatefulWidget {
  static const String routeName = 'session5_social_screen';

  @override
  State<SessionFiveSocial> createState() => _SessionFiveSocialState();
}

class _SessionFiveSocialState extends State<SessionFiveSocial> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        //           'assets/session5/Emotional_support.mp4'),
        //       looping: true,
        //       autoplay: true,
        //     ),
        //     TextButton(
