...
class SessionFivePsychoedu extends StatefulWidget {
  static const String routeName = 'session5_psychoedu_screen';

  @override
  State<SessionFivePsychoedu> createState() => _SessionFivePsychoeduState();
}

class _SessionFivePsychoeduState extends State<SessionFivePsychoedu> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text('PSYCHO-EDUCATION SESSION FIVE'),
          actions: [
            TextButton(
              onPressed: () =>
                  //sign out
        ...
        //           VideoPlayerController.asset('assets/session5/Diet.mp4'),
        //       looping: true,
        //       autoplay: true,
        //     ),
        //     TextButton(
