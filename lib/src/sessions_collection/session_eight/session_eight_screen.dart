...
const inactiveCardColour = Color(0xFF09ee52);
...
class SessionEightScreen extends StatefulWidget {
  static const String routeName = 'sessions_eight_screen';
  @override
  _SessionEightScreenState createState() => _SessionEightScreenState();
}
...
class _SessionEightScreenState extends State<SessionEightScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(getTranslated(context, "session8")),
        actions: [
          TextButton(
            onPressed: () => {
              //sign out
                    ...
                    Expanded(
                      child: ReusableCard(
                        onPress: () {
                          ...
                          Navigator.pushNamed(
                              context, SessionEightPsychoedu.routeName);
                        },
                    ...
                    Expanded(
                      child: ReusableCard(
                        onPress: () {
                          ...
                          Navigator.pushNamed(
                              context, SessionEightSocial.routeName);
                        },
                    ...
                    Expanded(
                      child: ReusableCard(
                        onPress: () {
                          ...
                          Navigator.pushNamed(
                              context, SessionEightPosPsycho.routeName);
                        },
                    ...
                    Expanded(
                      child: ReusableCard(
                        onPress: () {
                          ...
                          Navigator.pushNamed(
                              context, SessionEightSpiritual.routeName);
                        },
      ...
      floatingActionButton: FloatingActionButton.large(
        onPressed: () {
          ...
          Navigator.pushNamed(context, SessionEightFeedbackScreen.routeName);
        },
