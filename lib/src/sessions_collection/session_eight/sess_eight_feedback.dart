...
class SessionEightFeedbackScreen extends StatefulWidget {
  final String feedBackId;
  static const String routeName = 'session_eight_feedback_screen';

  const SessionEightFeedbackScreen({Key key, this.feedBackId})
      : super(key: key);

  @override
  _SessionEightFeedbackScreenState createState() =>
      _SessionEightFeedbackScreenState();
}

class _SessionEightFeedbackScreenState
    extends State<SessionEightFeedbackScreen> {
  ...
  String feedBackId = "Session 8 feedback";
