...
class SessionThreeSocial extends StatefulWidget {
  static const String routeName = 'session3_social_screen';

  @override
  State<SessionThreeSocial> createState() => _SessionThreeSocialState();
}

class _SessionThreeSocialState extends State<SessionThreeSocial> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('SOCIAL SESSION THREE'),
          actions: [
            TextButton(
              onPressed: () =>
                  //sign out
        ...
        //           'assets/session3/How_to_support.mp4'),
        //       looping: true,
        //       autoplay: true,
        //     ),
        //     TextButton(
