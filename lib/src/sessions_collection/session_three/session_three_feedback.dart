...
class SessionThreeFeedbackScreen extends StatefulWidget {
  final String feedBackId;
  static const String routeName = 'session_three_feedback_screen';

  const SessionThreeFeedbackScreen({Key key, this.feedBackId})
      : super(key: key);

  @override
  _SessionThreeFeedbackScreenState createState() =>
      _SessionThreeFeedbackScreenState();
}
...
class _SessionThreeFeedbackScreenState
  ...
  String feedBackId = "Session 3 feedback";
  ...
  void handleSubmitFeedback() {
    ...
    if (complete == true) {
      ...
      Navigator.pushReplacementNamed(context, SessionFourScreen.routeName);
    }
  }
