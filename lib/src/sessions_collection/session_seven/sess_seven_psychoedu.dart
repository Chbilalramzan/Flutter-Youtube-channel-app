...
class SessionSevenPsychoedu extends StatefulWidget {
  static const String routeName = 'session7_psychoedu_screen';

  @override
  State<SessionSevenPsychoedu> createState() => _SessionSevenPsychoeduState();
}

class _SessionSevenPsychoeduState extends State<SessionSevenPsychoedu> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text('PSYCHO-EDUCATION SESSION SEVEN'),
          actions: [
            TextButton(
              onPressed: () =>
                  //sign out
        ...
        //           VideoPlayerController.asset('assets/session7/Fistula.mp4'),
        //       looping: true,
        //       autoplay: true,
        //     ),
        //     TextButton(
