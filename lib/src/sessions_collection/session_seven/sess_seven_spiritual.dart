...
class SessionSevenSpiritual extends StatefulWidget {
  static const String routeName = 'session7_spiritual_screen';

  @override
  State<SessionSevenSpiritual> createState() => _SessionSevenSpiritualState();
}

class _SessionSevenSpiritualState extends State<SessionSevenSpiritual> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text('SPIRITUAL SESSION SEVEN'),
          actions: [
            TextButton(
              onPressed: () =>
                  //sign out
        ...
        //           VideoPlayerController.asset('assets/session7/Trust_Allah.mp4'),
        //       looping: true,
        //       autoplay: true,
        //     ),
        //     TextButton(
