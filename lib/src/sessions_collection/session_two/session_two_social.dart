...
class SessionTwoSocial extends StatefulWidget {
  static const String routeName = 'session2_social_screen';

  @override
  _SessionTwoSocialState createState() => _SessionTwoSocialState();
}

class _SessionTwoSocialState extends State<SessionTwoSocial> {
  ...
  //       VideoPlayerController.asset('assets/session2/sPeer_support.mp4');
