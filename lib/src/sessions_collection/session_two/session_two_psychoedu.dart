...
class SessionTwoPsycho extends StatefulWidget {
  static const String routeName = 'session2_psycho_screen';

  @override
  _SessionTwoPsychoState createState() => _SessionTwoPsychoState();
}

class _SessionTwoPsychoState extends State<SessionTwoPsycho> {
  ...
  //       VideoPlayerController.asset('assets/session2/Kidney.mp4');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('PSYCHO-EDUCATION SESSION TWO'),
          actions: [
            TextButton(
              onPressed: () =>
                  //sign out
